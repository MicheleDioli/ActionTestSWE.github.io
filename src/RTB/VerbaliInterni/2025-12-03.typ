...
Perciò si è deciso di assicurarsi che tutti i membri del gruppo avessero compreso i concetti espressi da M31 così da poter procedere con le attività di #gloss[analisi dei requisiti].
...
#table(
  ...
  [Scrittura e #gloss[verifica] verbale esterno],
  [Alessandro Dinato, Hossam Ezzemouri],
  [#link("#gloss[https]://#gloss[github].com/GlitchHub-Team/GlitchHub-Team.#gloss[github].io/issues/79")[*\#79*]],

  [Scrittura e #gloss[verifica] verbale interno],
  [Alessandro Dinato, Hossam Ezzemouri],
  [#link("#gloss[https]://#gloss[github].com/GlitchHub-Team/GlitchHub-Team.#gloss[github].io/issues/80")[*\#80*]],

  [Scrittura e #gloss[verifica] PdP #gloss[Sprint] 4],
  [Alessandro Dinato, Hossam Ezzemouri],
  [#link("#gloss[https]://#gloss[github].com/GlitchHub-Team/GlitchHub-Team.#gloss[github].io/issues/81")[*\#81*]],
)
