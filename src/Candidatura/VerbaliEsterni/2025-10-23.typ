...
I partecipanti si sono accordati di compilare un documento sulla piattaforma _#gloss[ClickUp]_ che raccogliesse tutte le domande da rivolgere al #gloss[proponente] *M31 SRL*. \
...
= Resoconto
I due rappresentanti si sono collegati puntualmente alle ore 10 per l'incontro con il #gloss[proponente] *M31 SRL*. \
...
Il gruppo aveva la necessità di conoscere l'importanza che il #gloss[proponente] dà ai vari requisiti opzionali con lo scopo di calcolare correttamente l'impegno da attuare. \
L'azienda ha risposto menzionando i requisiti *6* e *12* come i più importanti tra quelli opzionali. \
I requisiti menzionati si possono trovare nel #link("#gloss[https]://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C7.pdf")[documento del capitolato C7]. \
...
L'azienda ha chiarito che alcune tecnologie tra quelle menzionate nel documento non ha senso che vengano utilizzate nell'#gloss[MVP] per la ripida curva di apprendimento.\
M31 ha, inoltre, sconsigliato di utilizzare _#gloss[Apache Kafka]_ e _#gloss[Kubernetes]_ per il motivo citato in precedenza.\
Invece, ha consigliato _#gloss[NATS]_ e _#gloss[RabbitMQ]_ come tecnologie adatte allo scopo del nostro progetto.\
