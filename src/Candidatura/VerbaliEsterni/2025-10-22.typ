...
= Introduzione
Il seguente verbale attesta che in data *22 Ottobre 2025* è avvenuto l'incontro con il #gloss[proponente] *Miriade SRL*, in videoconferenza, dalle ore 15:30 alle ore 16. \
...
I partecipanti si sono accordati di compilare un documento sulla piattaforma _#gloss[ClickUp]_ che raccogliesse tutte le domande da rivolgere al #gloss[proponente] *Miriade SRL*. \
...
Ha inoltre consigliato di utilizzare *Flutter*, come indicato nel capitolato, sottolineando che il #gloss[framework] consente di compilare in modo nativo ed è preferibile rispetto ai linguaggi nativi, salvo esperienze pregresse.
...
L’attenzione deve quindi essere posta sia sull'#gloss[efficacia] delle funzionalità che sulla semplicità di utilizzo.
...
È stato chiesto se fosse possibile sviluppare l’#gloss[MVP] interamente per *iOS* o *Android*, al fine di integrare funzionalità native. \
...
È stata inoltre confermata la possibilità di inviare digitalmente il verbale per la firma da parte dell’azienda #gloss[proponente].
